  ...
  return (
    <Screen brand title="届け出を受け付けました">
      ...
      <div className="panel stack-sm" style={{ alignItems: 'flex-start' }}>
        ...
        <strong style={{ fontSize: 22, letterSpacing: '0.04em' }}>{code}</strong>
      ...
      {method === 'mail' && (
        <div className="panel panel--muted stack-sm" style={{ alignItems: 'flex-start' }}>
      ...
      <div className="stack-sm">
        ...
        <div className="row">
          {rc ? (
            <a href={`/return-cases/${rc}/link`} className="button primary">受け取り先を登録する</a>
          ) : null}
          <a href="/" className="button">ホームへ</a>
        </div>
      </div>
    </Screen>
  )
